...
function sellerChangeValidationStatusField(data, field) {
    ...
    if ((field.id == 'id_phone_number_0') || (field.id == 'id_phone_number_1')) {
        ...
        if ((phoneNumber0.name in data['body']) & (phoneNumber1.name in data['body']) || (phoneNumber1.value == '')) {
            radio.disabled = true
            if (radio.checked) {
                radio.checked = false
        ...
        const radio = document.getElementById(radioID)
        if ((field.name in data['body']) || (field.value == '')) {
            radio.disabled = true
            if (radio.checked) {
                radio.checked = false
                radios[0].checked = true
